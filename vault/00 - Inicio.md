...
- Pendiente: diseñar pantallas Crear/Editar/Vista en Figma (para reemplazar el Material por defecto) — el siguiente paso natural es la fase "Mostrar/localizar" de ADR-003.
