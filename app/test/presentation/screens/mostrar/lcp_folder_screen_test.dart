...
import 'package:lcp_builder/presentation/screens/mostrar/lcp_folder_screen.dart';
...
void main() {
  testWidgets('carpeta sin .lcp muestra el mensaje de "sin contenido"', (
    ...
    expect(find.text('Esta carpeta no tiene ningún archivo .lcp.'), findsOneWidget);
  });
    ...
    await tester.pumpWidget(
      wrapWithLocalization(
        LcpFolderScreen(
          ...
          // Se reenvía a LcpEntityTypesScreen al navegar — evita que el
